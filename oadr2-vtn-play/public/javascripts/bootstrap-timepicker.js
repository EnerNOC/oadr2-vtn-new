...
//                })
    ...
    , dropdownTemplate: '<div class="bootstrap-timepicker dropdown-menu">'+
                    '<table>'+
                        '<tr>'+
                            '<td><a href="#" data-action="incrementHour">&#x25B2</a></td>'+
                            '<td class="separator"></td>'+
                            '<td><a href="#" data-action="incrementMinute">&#x25B2</i></a></td>'+
                            '<td><a href="#" data-action="toggleMeridian">&#x25B2</a></td>'+
                        '</tr>'+
                        '<tr>'+
                        ...
                        '</tr>'+
                        '<tr>'+
                            '<td><a href="#" data-action="decrementHour">&#x25BC</a></td>'+
                            '<td class="separator"></td>'+
                            '<td><a href="#" data-action="decrementMinute">&#x25BC</a></td>'+
                            '<td><a href="#" data-action="toggleMeridian">&#x25BC</a></td>'+
                        '</tr>'+
                    '</table>'+
            '</div>'
    , modalTemplate: '<div class="bootstrap-timepicker modal hide fade in" style="top: 30%; margin-top: 0; width: 200px; margin-left: -100px;" data-backdrop="false">'+
                    '<div class="modal-header">'+
                        '<a href="#" class="close" data-action="hide">x</a>'+
                        '<h3>Pick a Time</h3>'+
                    '</div>'+
